  ...
  return (
    <section className="relative flex items-center justify-center overflow-hidden aurora pt-20">
      ...
      <div className="container mx-auto px-4 py-20 text-center">
        ...
        >
          <h1 className="text-5xl sm:text-6xl lg:text-7xl text-foreground mb-6">College Partnership</h1>
          <p className="text-xl text-foreground/70 max-w-2xl mx-auto">Empower your students with premium internship and training opportunities.</p>
        </motion.div>
      </div>
    </section>
  );
...
function ProcessSection() {
  const steps = [
    { number: '1', title: 'Connect', description: 'Reach out to our partnership team' },
    { number: '2', title: 'Integrate', description: 'We integrate with your college system' },
    { number: '3', title: 'Launch', description: 'Your students access opportunities' },
  ];
  ...
  return (
    <section className="py-20 border-t border-white/10">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-medium text-foreground mb-6">Ready to Partner?</h2>
          <p className="text-xl text-foreground/70 mb-8 max-w-2xl mx-auto">Join 500+ colleges already using {BRANDING.name} to empower their students.</p>
          <motion.button
